    ...
    return (
        <>
            <form className="max-w-lg w-full" onSubmit={handleSubmit}>
                <h1 className="text-[#3C3C3C] text-3xl font-bold mb-5">{t('SwitchDevice')}</h1>

                <p className='text-[#3C3C3C] font-medium'>
                    {t('transferMacAddress')}</p>
                <div className="mb-5 mt-10">
                    <label htmlFor="new-mac" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        {t('newMacAddress')} <span className='text-[#a1a1a1]'>{t('MaxLength')}: 17</span>
                    </label>
                    <input
                        type="text"
                        id="new-mac"
                ...
                <b className="text-[13px] block text-[#7D7E81]">
                    <span className="text-red-600">{t('noteTwo')}:</span> 
                    {t("noteDescTwo")}
                </b>
                <br />
                <center>

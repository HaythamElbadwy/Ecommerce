...
export default function Navbar() {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState(lng === 'en' ? "English" : "Arabic"); 
  ...
  return (
    <nav id='navbar' className="bg-[#000000] border-gray-200 dark:bg-gray-900 fixed w-full z-50 top-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-around mx-auto p-4">
        ...
        <div className="sm:w-0 flex items-center  md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
          ...
          <div className="relative inline-block text-left">
            ...
            {isDropdownOpen && (<div className="absolute mt-2 w-40 bg-white border rounded-md shadow-lg"
            >
